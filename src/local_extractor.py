...
ACTION_PATTERNS = {
    "suspicious_contact_received": ActionPatterns(
        ...
        _compile(r"(?:전화|문자|메시지|연락).{0,15}(?:왔|받|옴)|(?:검찰|경찰|금감원|은행).{0,12}(?:라며|라고|사칭)"),
    ...
    "app_installed": ActionPatterns(
        ...
        _compile(r"(?:앱|어플|프로그램).{0,20}(?:설치했|설치함|설치했습니다|설치하고|설치한|깔았|다운받았)"),
    ...
    "money_transferred": ActionPatterns(
        ...
        _compile(r"(?:송금|이체|입금)(?:했|함|했습니다)|(?:돈|현금|상품권).{0,18}(?:보냈|전달했|건넸)|안전계좌.{0,18}(?:옮겼|보냈)"),
