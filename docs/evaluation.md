...
문맥 50건의 마스킹 라벨은 2개이며, 개인정보 보호 기능 자체는 별도의 합성 데이터 30건으로
평가한다. 주민등록번호·전화번호·이메일·카드번호·인증번호·비밀번호·계좌번호를 다양한 표기로
...
| 사례 통과율 | 100.00% (30/30) |
| 유형 완전일치율 | 100.00% |
| 마스킹 개수 정확도 | 100.00% (44/44) |
| 필수 사건정보 보존율 | 100.00% (27/27) |
| 금지 유형 발생률 | 0.00% |
...
- [O] 7개 민감정보 유형의 합성 마스킹 평가 30건 확보
- [ ] 평가 라벨 2인 교차 검토
