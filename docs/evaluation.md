...
문맥 50건의 마스킹 라벨은 2개이며, 개인정보 보호 기능 자체는 별도의 합성 데이터 40건으로
...
| 사례 통과율 | 100.00% (40/40) |
| 유형 완전일치율 | 100.00% |
| 마스킹 개수 정확도 | 100.00% (45/45) |
| 마스킹 자리표시자 정확도 | 100.00% (43/43) |
| 필수 사건정보 보존율 | 100.00% (59/59) |
| 금지 유형 발생률 | 0.00% |
...
- [O] 7개 민감정보 유형의 합성 마스킹 평가 40건 확보
- [ ] 평가 라벨 2인 교차 검토
